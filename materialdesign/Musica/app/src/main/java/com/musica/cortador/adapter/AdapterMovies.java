...
import com.musica.cortador.customview.AnimationUtils;
...
public class AdapterMovies extends RecyclerView.Adapter<AdapterMovies.ViewHolderBoxOffice> {
    ...
    public ViewHolderBoxOffice onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.row_movie_box, parent, false);
    ...
    public void onBindViewHolder(ViewHolderBoxOffice holder, int position) {
        ...
        if (movieReleaseDate != null) {
            ...
            holder.movieReleaseDate.setText("Not Available");
        }
...
//            AnimationUtils.animate1(holder, false);
    ...
    private void loadImages(String urlThumbnail, final ViewHolderBoxOffice holder) {
        if (!urlThumbnail.equals("Not Available")) {
